      ...
      <div className="mt-10 flex flex-col gap-12">
        ...
        <section>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            >
              <span className="text-[10px] tracking-widest text-bg/70">[ USAGE ]</span>
              ...
              <span className="mt-2 text-[10px] tracking-widest text-bg/70">&gt; START</span>
            </Link>
            <Link
              href="/docs/install"
              className="ascii-box group flex flex-col gap-2 border-purple-bright bg-purple p-5 transition-transform hover:-translate-y-1"
            >
              <span className="text-[10px] tracking-widest text-bg/70">[ INSTALL ]</span>
              ...
              <span className="mt-2 text-[10px] tracking-widest text-bg/70">&gt; GET IT</span>
            </Link>
            <Link
              href="/docs/cli"
              className="ascii-box group flex flex-col gap-2 bg-bg-soft p-5 transition-transform hover:-translate-y-1"
            >
              <span className="text-[10px] tracking-widest text-muted">[ CLI ]</span>
              <span className="text-sm font-black tracking-widest text-purple-bright group-hover:glow-purple-soft">
                CLI REFERENCE
              </span>
