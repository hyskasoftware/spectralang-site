          ...
          {(prev || next) && (
            <div className="mt-10 grid grid-cols-2 gap-4 border-t-2 border-border-strong pt-6">
              {prev ? (
                <Link
                  href={prev.href}
                  className="ascii-box bg-bg p-4 transition-transform hover:-translate-y-0.5"
                >
                  <p className="text-[9px] tracking-widest text-muted">{"< PREV"}</p>
                  <p className="mt-1 text-xs font-bold tracking-widest text-purple-bright">
                    {prev.label}
                  </p>
                </Link>
              ) : (
              ...
              {next ? (
                <Link
                  href={next.href}
                  className="ascii-box bg-bg p-4 text-right transition-transform hover:-translate-y-0.5"
                >
